...
command.option("-g", "--git").bool().help("Open \0red([\0bold(RED\0)]\0) with `stree` - Sourcetree (http://www.sourcetreeapp.com) \0magenta([No affiliation with sourcemint]\0)");
command.option("-d", "--dirty").bool().help("Only fix dirty.");
command.helpful();
