...
command.option("-g", "--git").bool().help("[default] Open \0red([\0bold(git\0)]\0) with `stree` - Sourcetree (http://www.sourcetreeapp.com) \0magenta([No affiliation with sourcemint]\0)");
command.option("-d", "--dirty").bool().help("[default] Only fix \0red([\0bold(git dirty\0)]\0)");
command.helpful();
